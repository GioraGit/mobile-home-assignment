package com.giora.climasale.services.views;
...
public class ScrollAwareFABBehavior extends FloatingActionButton.Behavior {
	...
	public boolean onStartNestedScroll(@NonNull final CoordinatorLayout coordinatorLayout,
									   ...
									   @NonNull final View target, final int nestedScrollAxes) {
		// Ensure we react to vertical scrolling
		boolean b = super.onStartNestedScroll(coordinatorLayout, child, directTargetChild, target, nestedScrollAxes);
